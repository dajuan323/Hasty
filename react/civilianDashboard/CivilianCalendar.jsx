...
function CivilianCalendar() {
  ...
  const onGetPageError = () => {
    toastr['info']('No Reservations Provided');
  };
    ...
    <>
      <div>
        <Card className="height-calendar">
          <Card.Body>
            <Row>
              <Col className="col-lg-4 ms-4 mt-2 mb-1 ">
              ...
              <Col className="calendar-widget col-lg-7 ms-2 mt-2">
...
export default CivilianCalendar;
